...
<h2>Student Registration Form</h2>
  <form:form action="save" method="post" class="form-horizontal" modelAttribute="student">
   <div class="row">
      ...
      <div class="row">
       ...
       <div class="row">
         <div class="form-group col-md-12">
            ...
            <div class="col-md-7" >
              <form:select  path="subjects" id="subjects" items="${subjects}" class="form-control input-sm"/>
              <div class="has-error">
